...
steps = [
	...
	function(){
		page.evaluate(function(){
			document.getElementById("twotabsearchtextbox").value="macbook pro";
		});
    },
	//Step 3 - Populate and submit the login form
    function(){
		page.evaluate(function(){
            document.querySelector("#nav-search > form > div.nav-right > div > input").click();
		});
    },
